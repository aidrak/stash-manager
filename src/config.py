    ...
    try:
        ...
        config = {
            ...
            'jobs': settings.get('jobs', {
                'add_new_scenes': True,
                'add_new_scenes_schedule': 720,
                'add_new_scenes_search_back_days': 7,
                'clean_existing_scenes': False,
                'clean_existing_scenes_schedule': 1440
            }),
            'general': settings.get('general', {
                'dry_run': True
            }),
            'identify': settings.get('identify', {
                'enabled': False,
                'sources': []
            }),
            ...
            'one_time_search': settings.get('one_time_search', {
                'start_date': '',
                'end_date': ''
            }),
        ...
        if not validate_config(config, strict=strict):
            if strict:
                ...
                logging.warning("Configuration validation failed, but continuing in non-strict mode.")
